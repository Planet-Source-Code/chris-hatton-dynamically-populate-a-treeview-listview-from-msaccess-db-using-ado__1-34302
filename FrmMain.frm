...
TreeView1.Width = Me.Width - TableView1.Width - 400
TableView1.Left = TreeView1.Width + 200
TableView1.Width = Me.Width - TreeView1.Width - 400
TableView1.Height = Me.Height - TableView1.Top - 800
TreeView1.Height = Me.Height - TreeView1.Top - 1500
ProgressBar1.Top = TreeView1.Height + TreeView1.Top
ProgressBar1.Width = TreeView1.Width
Label2.Top = ProgressBar1.Top + ProgressBar1.Height + Label2.Height - 100
End Sub
...
Private Sub AddItem()
  On Error GoTo AddUpdateErr
     ...
     NewItem = InputBox("Type your " & TreeView1.SelectedItem.Parent.Text & " Item", "Add New Item")
